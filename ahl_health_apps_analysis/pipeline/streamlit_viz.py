...
import pandas as pd
from ahl_health_apps_analysis.pipeline.plotting import configure_plots

date = ('2022-11-28')
clusters = 20

data = pd.read_csv(f'ahl_health_apps_analysis/pipeline/{date}-kmeans-{clusters}-refined.csv') 
